...
const Faq = () => {
  return (
    <div className="flex flex-col items-center justify-center relative w-full py-16 lg:py-24 overflow-hidden">
      <div className="absolute top-0 -right-1/3 -z-10 ml-auto w-4/5 h-32 lg:h-48 rounded-full blur-[5rem] bg-[radial-gradient(86.02%_172.05%_at_50%_-40%,rgba(139,92,246,0.7)_0%,rgba(5,5,5,0)_80%)]"></div>
      ...
      <Wrapper>
          ...
          <Container>
            <div className="col-span-1 w-full z-10">
              <div className="flex w-full">
                {/* Ensure this image exists or remove it */}
                {/* <Image
                  src="/images/faq.svg"
                  alt="Box"
                  width={1024}
        ...
        {/* Gradient blur facing upward - positioned above footer */}
        <div className="absolute bottom-0 inset-x-0 -z-10 mx-auto w-3/4 h-32 lg:h-40 rounded-full blur-[5rem] bg-[radial-gradient(86.02%_172.05%_at_50%_140%,rgba(139,92,246,0.8)_0%,rgba(5,5,5,0)_80%)]"></div>
      </Wrapper>
    </div>
  );
};
