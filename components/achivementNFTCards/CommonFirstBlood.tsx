...
interface CommonFirstBloodProps {
  locked?: boolean;
}

export default function CommonFirstBlood({
  locked = false,
}: CommonFirstBloodProps) {
  return (
    <Card
      className="
        relative 
    ...
    >
      ...
      <div
        className="absolute top-0 left-0 w-full h-[2px] rounded-t-[16px] shadow-[0_0_10px_#99A1AF]"
        style={{
      ...
      <div className="flex justify-between items-center relative z-10 shrink-0">
        <div className="flex items-center gap-2">
          <div className="w-2 h-2 rounded-full bg-[#99A1AF]" />
          <span className="text-[15px] font-medium text-[#99A1AF]">Common</span>
        </div>
      ...
      >
        <div className="flex justify-between items-center mb-3">
          ...
          <span className="text-[13px] text-gray-500">2 perks</span>
        </div>
