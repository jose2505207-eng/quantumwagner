    ...
    <div className="min-h-screen text-white p-8 pt-24">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="text-center mb-12 px-4 sm:px-0">
          ...
          <h1 className="text-5xl font-bold mb-4 leading-tight sm:text-4xl">
            Rise to the Top of
            <br />
            CoinBuzz Elite
          </h1>
          <p className="text-gray-400 text-lg max-w-2xl mx-auto">
            ...
            exclusive rewards. Track your performance against the
            community&lsquo;s top predictors.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {stats.map((stat, index) => (
            <div
              key={index}
              className="bg-gray-900/50 rounded-xl p-6 text-center backdrop-blur-sm border border-gray-800"
            >
              ...
              <div className="bg-gray-900/50 rounded-xl border border-gray-800 overflow-hidden">
                <div className="p-6 border-b border-gray-800">
                  <div className="flex justify-between items-center flex-wrap">
                    ...
                    <span className="text-gray-400 text-sm mt-2 lg:mt-0">
                    ...
                    >
                      <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between space-y-4 lg:space-y-0">
                        <div className="flex items-center space-x-4 flex-wrap">
                          ...
                          <div
                            className={`w-12 h-12 rounded-full ${predictor.color} flex items-center justify-center font-bold text-white`}
                          >
                            {predictor.avatar}
                          </div>
                        ...
                        <div className="flex flex-wrap lg:flex-nowrap items-center space-x-4 lg:space-x-8 w-full lg:w-auto justify-between">
                          ...
                          <button className="px-4 py-2 bg-purple-600 hover:bg-purple-700 rounded-lg text-sm font-medium transition-colors mt-2 lg:mt-0">
                            Follow
                          </button>
                        </div>
                      </div>
